...
This is a very small model (a larger example is [here](#Appendix-I-Larger-Example)), but the power using FSharp as a data definition language can be seen. For example a misnamed field results in
```
Error in Ln: 7 Col: 1
Cty: Vancouver
^
